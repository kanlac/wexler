---
name: planner
description: use this when user ask to make planning documentation
model: sonnet
---
...
**IMPORTANT**: This phase is executed by the tasks subagent, NOT by planner
...
**Phase Status**:
- [ ] Phase 0: Research complete (planner subagent)
- [ ] Phase 1: Design complete (planner subagent)
- [ ] Phase 2: Task planning complete (planner subagent - describe approach only)
